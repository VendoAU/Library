...
public class PacketUtil {
    ...
    public static PlayerInfoPacket addPlayerInfoPacket(UUID uuid, String username) {
        return addPlayerInfoPacket(uuid, username, PlayerSkin.fromUuid(uuid.toString()));
    }
